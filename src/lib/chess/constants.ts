...
export const AI_CONFIG = {
    easy: {
        name: 'Easy',
        description: 'Relaxed game - frequent mistakes',
        searchDepth: 2,
        blunderChance: 0.35,
        thinkTime: { min: 500, max: 1500, avg: 1000 },
    },
    medium: {
        name: 'Medium',
        description: 'Balanced challenge - occasional mistakes',
        searchDepth: 3,
        blunderChance: 0.15,
        thinkTime: { min: 1000, max: 2500, avg: 1500 },
    },
    difficult: {
        name: 'Difficult',
