        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            ...
            >
                ...
                <div className="bg-surface rounded-lg p-4 mb-6 text-left">
                    <h3 className="font-semibold mb-3 text-secondary">Create account and get:</h3>
                    <ul className="space-y-2 text-sm text-gray-400">
                        <li className="flex items-center gap-2">
                            <span className="text-primary">&#10003;</span>
                            <span>1,000 free tokens to start playing</span>
                        </li>
                        <li className="flex items-center gap-2">
                            <span className="text-primary">&#10003;</span>
                            <span>Track your wins, rating, and statistics</span>
                        </li>
                        <li className="flex items-center gap-2">
                            <span className="text-primary">&#10003;</span>
                            <span>Earn weekly bonuses (up to 70 tokens)</span>
                        </li>
                        <li className="flex items-center gap-2">
                            <span className="text-primary">&#10003;</span>
